...
@app_views.route("/mentors/<mentor_id>", methods=['DELETE'], strict_slashes=False)
...
def update_mentor(mentor_id: str = None) -> str:
    ...
    if request_json is None:
        ...
        try:
            ...
            if mentor is None:
                abort(404)
            mentor.first_name = request_json.get('first_name', mentor.first_name)
            mentor.last_name = request_json.get('last_name', mentor.last_name)
